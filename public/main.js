...
module.exports = ".container {\n  padding: 20px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _component_station_status_station_status_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./component/station-status/station-status.component */ "./src/app/component/station-status/station-status.component.ts");
/* harmony import */ var _component_station_status_toolbar_template_toolbar_template_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./component/station-status/toolbar-template/toolbar-template.component */ "./src/app/component/station-status/toolbar-template/toolbar-template.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _component_station_status_station_status_component__WEBPACK_IMPORTED_MODULE_23__["StationStatusComponent"],
                _component_station_status_toolbar_template_toolbar_template_component__WEBPACK_IMPORTED_MODULE_24__["ToolbarTemplateComponent"],
...
/***/ "./src/app/component/all-stations/all-stations.component.html":
/*!********************************************************************!*\
  !*** ./src/app/component/all-stations/all-stations.component.html ***!
  \********************************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"tableContainer\">\n  <!-- <table id=\"station\">\n    <tr>\n      <th class=\"link\" (click)=\"sortDatabyName()\">Station Name</th>\n      <th class=\"link\" (click)=\"sortDatabyactive()\">Status</th>\n      <th class=\"link\" (click)=\"sortDatabyaTime()\">Time</th>\n      <th class=\"link\" (click)=\"sortDatabyaTime()\">Last data log</th>\n    </tr>\n    <tr *ngFor=\"let ele of tableDataSet\">\n      <td>{{ele.name}}</td>\n      <td>\n        <mat-icon style=\"color:green\" *ngIf=\"ele.active == 2\" class=\"example-icon\" aria-hidden=\"false\"\n          aria-label=\"Example heart icon\">check_circle_outline\n        </mat-icon>\n        <mat-icon style=\"color:rgb(223, 148, 10)\" *ngIf=\"ele.active == 1\" class=\"example-icon\" aria-hidden=\"false\"\n          aria-label=\"Example heart icon\">warning\n        </mat-icon>\n        <mat-icon style=\"color:red\" *ngIf=\"!ele.active\" class=\"example-icon\" aria-hidden=\"false\"\n          aria-label=\"Example heart icon\">highlight_off\n        </mat-icon>\n\n      </td>\n      <td>{{ele.latTime}}</td>\n      <td>{{ele.days}} Days {{ele.hours}} Hours {{ele.min}} Minute</td>\n    </tr>\n  </table> -->\n  <!-- <app-row></app-row> -->\n  <mat-grid-list cols=\"4\" rowHeight=\"7:1\" class=\"headder\">\n    <mat-grid-tile>\n      <div class=\"text-inside-grid\">Station Name</div>\n    </mat-grid-tile>\n    <mat-grid-tile>\n      <div class=\"text-inside-grid\">Status</div>\n    </mat-grid-tile>\n    <mat-grid-tile>\n      <div class=\"text-inside-grid\">Time</div>\n    </mat-grid-tile>\n    <mat-grid-tile>\n      <div class=\"text-inside-grid\">Last data log</div>\n    </mat-grid-tile>\n  </mat-grid-list>\n  <div *ngFor=\"let satation of StationList; let i = index\">\n    <div class=\"separator\">\n      <div class=\"link\">\n        <app-row (click)=\"changeStation(satation.id,satation.name)\" id={{satation.id}} name={{satation.name}} count = {{i}}></app-row>\n      </div>\n    </div>\n  </div>\n</div>"

/***/ }),

/***/ "./src/app/component/all-stations/all-stations.component.scss":
/*!********************************************************************!*\
  !*** ./src/app/component/all-stations/all-stations.component.scss ***!
  \********************************************************************/
/*! no static exports found */
...
module.exports = ".tableContainer {\n  padding: 25px; }\n\n#station {\n  font-family: \"Trebuchet MS\", Arial, Helvetica, sans-serif;\n  font-size: 16px;\n  border-collapse: collapse;\n  width: 100%; }\n\n#station td, #station th {\n  border: 0px solid #ddd;\n  padding: 8px; }\n\n#station tr:nth-child(even) {\n  background-color: rgba(0, 0, 0, 0.032); }\n\n#station tr:hover {\n  background-color: rgba(255, 255, 255, 0.2); }\n\n#station th {\n  padding-top: 12px;\n  padding-bottom: 12px;\n  text-align: left;\n  background-color: rgba(0, 0, 0, 0.2);\n  color: white; }\n\n.headder {\n  text-align: left;\n  background-color: rgba(0, 0, 0, 0.2);\n  color: white; }\n\n.link {\n  cursor: pointer; }\n\n.text-inside-grid {\n  font-family: \"Trebuchet MS\", Arial, Helvetica, sans-serif;\n  position: absolute;\n  font-size: 18px;\n  left: 5px;\n  padding-top: 12px;\n  padding-bottom: 12px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/component/all-stations/all-stations.component.ts":
/*!******************************************************************!*\
  !*** ./src/app/component/all-stations/all-stations.component.ts ***!
  \******************************************************************/
/*! exports provided: AllStationsComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AllStationsComponent", function() { return AllStationsComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var AllStationsComponent = /** @class */ (function () {
    function AllStationsComponent(apiService, data, changeDetectorRefs) {
        this.apiService = apiService;
        this.data = data;
        this.changeDetectorRefs = changeDetectorRefs;
        this.StationList = this.data.stationList;
    }
    AllStationsComponent.prototype.ngOnInit = function () {
    };
    AllStationsComponent.prototype.ngOnDestroy = function () {
    };
    AllStationsComponent.prototype.changeStation = function (id, name) {
        this.data.changStation(id, name);
        this.data.change(false);
    };
    AllStationsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-all-stations',
            template: __webpack_require__(/*! ./all-stations.component.html */ "./src/app/component/all-stations/all-stations.component.html"),
            styles: [__webpack_require__(/*! ./all-stations.component.scss */ "./src/app/component/all-stations/all-stations.component.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_service_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"], _service_data_service__WEBPACK_IMPORTED_MODULE_3__["DataService"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"]])
    ], AllStationsComponent);
    return AllStationsComponent;
}());
...
/***/ "./src/app/component/all-stations/row/row.component.html":
/*!***************************************************************!*\
  !*** ./src/app/component/all-stations/row/row.component.html ***!
  \***************************************************************/
/*! no static exports found */
...
module.exports = "<mat-grid-list cols=\"4\" rowHeight=\"8:1\" [ngClass]=\"count%2==1?'type2':'type1'\">\n    <mat-grid-tile>\n        <div class=\"text-inside-grid\">{{tonumber(count)}}. {{name}}\n        </div>\n        <!-- <mat-progress-spinner class=\"inline\" *ngIf=\"!ready\" [diameter]=\"15\" mode=\"indeterminate\"></mat-progress-spinner> -->\n    </mat-grid-tile>\n    <mat-grid-tile>\n        <div class=\"text-inside-grid\">\n            <mat-icon style=\"color:green\" *ngIf=\"active==2&&ready\" class=\"example-icon\" aria-hidden=\"false\"\n                aria-label=\"Example heart icon\" matTooltip=\"Active\"matTooltipClass=\"example-tooltip-green\">check_circle_outline</mat-icon>\n            <mat-icon style=\"color:rgb(231, 153, 8)\" *ngIf=\"active==1&&ready\" class=\"example-icon\" aria-hidden=\"false\"\n                aria-label=\"Example heart icon\" matTooltip=\"Warning\" matTooltipClass=\"example-tooltip-orange\">warning</mat-icon>\n            <mat-icon style=\"color:red\" *ngIf=\"active==0&&ready\" class=\"example-icon\" aria-hidden=\"false\"\n                aria-label=\"Example heart icon\" matTooltip=\"Not working\" matTooltipClass=\"example-tooltip-red\">highlight_off</mat-icon>\n        </div>\n    </mat-grid-tile>\n    <mat-grid-tile>\n        <div class=\"text-inside-grid\">{{this.time.lastTime}} {{this.time.lastdate}}</div>\n    </mat-grid-tile>\n    <mat-grid-tile>\n        <div class=\"text-inside-grid\">{{this.time.difDate}} Days {{this.time.difHour}} Hours {{this.time.difMin}}\n            Minutes</div>\n    </mat-grid-tile>\n</mat-grid-list>\n<mat-divider></mat-divider>"

/***/ }),

/***/ "./src/app/component/all-stations/row/row.component.scss":
/*!***************************************************************!*\
  !*** ./src/app/component/all-stations/row/row.component.scss ***!
  \***************************************************************/
/*! no static exports found */
...
module.exports = ".text-inside-grid {\n  font-family: \"Trebuchet MS\", Arial, Helvetica, sans-serif;\n  position: absolute;\n  font-size: 16px;\n  left: 5px; }\n\nmat-grid-list:hover {\n  background-color: rgba(255, 255, 255, 0.2); }\n\n.type1 {\n  background-color: rgba(255, 255, 255, 0.032); }\n\n.type2 {\n  background-color: rgba(0, 0, 0, 0.032); }\n\n.inline {\n  display: inline-block;\n  margin: 10px 10px; }\n\n::ng-deep.example-tooltip-red {\n  background: #b71c1c; }\n\n::ng-deep.example-tooltip-green {\n  background: green; }\n\n::ng-deep.example-tooltip-orange {\n  background: orange; }\n\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/component/all-stations/row/row.component.ts":
/*!*************************************************************!*\
  !*** ./src/app/component/all-stations/row/row.component.ts ***!
  \*************************************************************/
...
var RowComponent = /** @class */ (function () {
    function RowComponent(apiService) {
        this.apiService = apiService;
    ...
    RowComponent.prototype.getdata = function () {
        var _this = this;
        this.apiService.getLastDataLog({ station: this.id }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this.ngUnsubscribe)).subscribe(function (result) {
            console.log(result);
            if (result.success) {
    ...
    RowComponent.prototype.convert = function (value) {
        return Number(value).toFixed(2);
    };
    RowComponent.prototype.tonumber = function (value) {
        return Number(value) + 1;
    };
    RowComponent.prototype.evaluate = function (endDate) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var now, end, duration;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                now = moment_timezone__WEBPACK_IMPORTED_MODULE_5__().tz("Asia/Colombo");
                end = moment_timezone__WEBPACK_IMPORTED_MODULE_5__(endDate).tz("Asia/Colombo");
                duration = moment__WEBPACK_IMPORTED_MODULE_4__["duration"](now.diff(end));
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", String)
    ], RowComponent.prototype, "name", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])('count'),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Number)
    ], RowComponent.prototype, "count", void 0);
    RowComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-row',
            template: __webpack_require__(/*! ./row.component.html */ "./src/app/component/all-stations/row/row.component.html"),
            styles: [__webpack_require__(/*! ./row.component.scss */ "./src/app/component/all-stations/row/row.component.scss")]
        }),
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiIuLi9sYXlvdXQvbGF5b3V0LmNvbXBvbmVudC5zY3NzIn0= */"
...
module.exports = ".sidenav-container {\n  height: 100%;\n  background-image: url('background2.png');\n  background-size: cover;\n  /* background-image: linear-gradient(to right bottom, rgba(75, 204, 255), rgb(39, 39, 189)); */\n}\n\n.sidenav {\n  width: 300px;\n  border-right: 0;\n  box-shadow: 3px 0 6px rgba(0, 0, 0, 0.24);\n  background-color: rgba(255, 255, 255, 1);\n}\n\n/*Toolbar drop shadow*/\n\n.matToolbar {\n  box-shadow: 0px 5px 6px rgba(0, 0, 0, 0.24);\n}\n\n.mat-toolbar.mat-primary {\n  position: -webkit-sticky;\n  position: sticky;\n  top: 0;\n  z-index: 1;\n}\n\n.toolbar-icon {\n  padding: 0 5px 0 20px;\n}\n\n/* alignment of icons */\n\n.toolbar-spacer {\n  flex: 1 1 auto;\n}\n\n.content {\n  padding: 10px;\n}\n\n.canclick {\n  cursor: pointer;\n}\n\n.no-v-scroll {\n  height: 100%;\n  overflow-y: hidden; \n  display: flex; \n  flex-direction: column;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var MainNavComponent = /** @class */ (function () {
    function MainNavComponent(breakpointObserver, data) {
        var _this = this;
    ...
    MainNavComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.data.currentPage.subscribe(function (status) {
            _this.page = status;
        });
    };
    MainNavComponent.prototype.changePage = function () {
        this.page = true;
    };
    MainNavComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_cdk_layout__WEBPACK_IMPORTED_MODULE_2__["BreakpointObserver"], _service_data_service__WEBPACK_IMPORTED_MODULE_4__["DataService"]])
    ], MainNavComponent);
...
module.exports = ".example-icon {\n  padding: 0 14px; }\n\n.example-spacer {\n  flex: 1 1 auto; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiIuLi9zaWRlYmFyL3NpZGViYXIuY29tcG9uZW50LnNjc3MifQ== */"
...
/***/ "./src/app/component/station-status/station-status.component.html":
/*!************************************************************************!*\
  !*** ./src/app/component/station-status/station-status.component.html ***!
  \************************************************************************/
/*! no static exports found */
...
module.exports = "<div *ngFor=\"let satation of StationList\">\n  <div class=\"separator\">\n    <div class=\"link\">\n        <app-toolbar-template (click)=\"changeStation(satation.id,satation.name)\" id={{satation.id}} name = {{satation.name}}></app-toolbar-template>\n    </div>\n  </div>\n</div>"

/***/ }),

/***/ "./src/app/component/station-status/station-status.component.scss":
/*!************************************************************************!*\
  !*** ./src/app/component/station-status/station-status.component.scss ***!
  \************************************************************************/
/*! no static exports found */
...
module.exports = ".separator {\n  padding: 10px; }\n\n.link {\n  cursor: pointer; }\n\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/component/station-status/station-status.component.ts":
/*!**********************************************************************!*\
  !*** ./src/app/component/station-status/station-status.component.ts ***!
  \**********************************************************************/
/*! exports provided: StationStatusComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StationStatusComponent", function() { return StationStatusComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _service_data_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../service/data.service */ "./src/app/service/data.service.ts");
...
var StationStatusComponent = /** @class */ (function () {
    ...
    StationStatusComponent.prototype.changeStation = function (id, name) {
...
/***/ "./src/app/component/station-status/toolbar-template/toolbar-template.component.html":
/*!*******************************************************************************************!*\
  !*** ./src/app/component/station-status/toolbar-template/toolbar-template.component.html ***!
  \*******************************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/component/station-status/toolbar-template/toolbar-template.component.scss":
/*!*******************************************************************************************!*\
  !*** ./src/app/component/station-status/toolbar-template/toolbar-template.component.scss ***!
  \*******************************************************************************************/
/*! no static exports found */
...
module.exports = ".toolbar {\n  background-color: rgba(0, 0, 0, 0.1); }\n\n.toolbarActive {\n  background-color: rgba(0, 128, 0, 0.1); }\n\n.toolbarDeactive {\n  background-color: rgba(255, 0, 0, 0.1); }\n\n.example-icon {\n  padding: 0 14px; }\n\n.example-spacer {\n  flex: 1 1 auto; }\n\n.active {\n  color: green; }\n\n.deactive {\n  color: red; }\n\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/component/station-status/toolbar-template/toolbar-template.component.ts":
/*!*****************************************************************************************!*\
  !*** ./src/app/component/station-status/toolbar-template/toolbar-template.component.ts ***!
  \*****************************************************************************************/
/*! exports provided: ToolbarTemplateComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ToolbarTemplateComponent", function() { return ToolbarTemplateComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _service_api_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../service/api.service */ "./src/app/service/api.service.ts");
...
var ToolbarTemplateComponent = /** @class */ (function () {
    ...
    ToolbarTemplateComponent.prototype.getdata = function () {
        var _this = this;
        this.apiService.getLastDataLog({ station: this.id }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.ngUnsubscribe)).subscribe(function (result) {
            console.log(result);
            if (result.success) {
                _this.toolbarModel = result;
                _this.evaluate(result.dateTime);
    ...
    ToolbarTemplateComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! ./toolbar-template.component.html */ "./src/app/component/station-status/toolbar-template/toolbar-template.component.html"),
            styles: [__webpack_require__(/*! ./toolbar-template.component.scss */ "./src/app/component/station-status/toolbar-template/toolbar-template.component.scss")]
        }),
...
module.exports = ".card {\n  max-width: 300px;\n  background-color: rgba(0, 0, 0, 0.025);\n  color: white; }\n\n.contentText {\n  font-size: 30px;\n  font-family: \"Lucida Sans\", \"Lucida Sans Regular\", \"Lucida Grande\", \"Lucida Sans Unicode\", Geneva, Verdana, sans-serif;\n  text-align: center; }\n\n.error {\n  font-size: 30px;\n  font-family: \"Lucida Sans\", \"Lucida Sans Regular\", \"Lucida Grande\", \"Lucida Sans Unicode\", Geneva, Verdana, sans-serif;\n  text-align: center;\n  color: red; }\n\n.header-image {\n  background-size: cover; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".card {\n  max-width: 300px;\n  background-color: rgba(0, 0, 0, 0.075);\n  color: white; }\n\n.contentText {\n  font-size: 50px;\n  font-family: \"Lucida Sans\", \"Lucida Sans Regular\", \"Lucida Grande\", \"Lucida Sans Unicode\", Geneva, Verdana, sans-serif;\n  text-align: center; }\n\n.example-header-image {\n  background-image: url('humidity.png');\n  background-size: cover; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "table {\n  width: 100%;\n  background-color: rgba(0, 0, 0, 0.032); }\n\n.example-container {\n  overflow: auto; }\n\n.hedder {\n  color: white;\n  font-size: 16px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".card {\n  max-width: 300px;\n  background-color: rgba(0, 0, 0, 0.05);\n  color: white; }\n\n.contentText {\n  font-size: 50px;\n  font-family: \"Lucida Sans\", \"Lucida Sans Regular\", \"Lucida Grande\", \"Lucida Sans Unicode\", Geneva, Verdana, sans-serif;\n  text-align: center; }\n\n.example-header-image {\n  background-image: url('pressure.png');\n  background-size: cover; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".card {\n  max-width: 300px;\n  background-color: rgba(0, 0, 0, 0.1);\n  color: white; }\n\n.contentText {\n  font-size: 50px;\n  font-family: \"Lucida Sans\", \"Lucida Sans Regular\", \"Lucida Grande\", \"Lucida Sans Unicode\", Geneva, Verdana, sans-serif;\n  text-align: center; }\n\n.example-header-image {\n  background-image: url('rain.png');\n  background-size: cover; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".card {\n  max-width: 300px;\n  background-color: rgba(0, 0, 0, 0.025);\n  color: white; }\n\n.contentText {\n  font-size: 50px;\n  font-family: \"Lucida Sans\", \"Lucida Sans Regular\", \"Lucida Grande\", \"Lucida Sans Unicode\", Geneva, Verdana, sans-serif;\n  text-align: center; }\n\n.example-header-image {\n  background-image: url('Temperature-icon.png');\n  background-size: cover; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".inline {\n  display: inline-block;\n  margin: 10px 10px; }\n\n.headdign {\n  color: #fff;\n  font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;\n  margin-top: 5px; }\n\n.error {\n  color: red;\n  font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;\n  text-align: center; }\n\n/* Absolute Center Spinner */\n\n.loading-indicator {\n  position: fixed;\n  z-index: 999;\n  height: 2em;\n  width: 2em;\n  overflow: show;\n  margin: auto;\n  top: 0;\n  left: 0;\n  bottom: 0;\n  right: 0; }\n\n/* Transparent Overlay */\n\n.loading-indicator:before {\n  content: '';\n  display: block;\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  background-color: rgba(0, 0, 0, 0.3); }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var WeatherCardComponent = /** @class */ (function () {
    ...
    WeatherCardComponent.prototype.ngOnInit = function () {
        ...
        this.getdata(true);
        this.refreshStation = setInterval(function () {
            _this.getdata(false);
        }, 30000);
    };
    ...
    WeatherCardComponent.prototype.getdata = function (isFirstload) {
        ...
        if (isFirstload)
            this.loadingFlag = true;
        this.apiService.getThisTimeData({ station: this.stationName }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.ngUnsubscribe)).subscribe(function (data) {
            if (data[0].success) {
    ...
    WeatherCardComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_service_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"], _service_data_service__WEBPACK_IMPORTED_MODULE_6__["DataService"]])
...
module.exports = ".card {\n  max-width: 300px;\n  background-color: rgba(0, 0, 0, 0.15);\n  color: white; }\n\n.contentText {\n  font-size: 50px;\n  font-family: \"Lucida Sans\", \"Lucida Sans Regular\", \"Lucida Grande\", \"Lucida Sans Unicode\", Geneva, Verdana, sans-serif;\n  text-align: center; }\n\n.example-header-image {\n  background-image: url('WindDirection.png');\n  background-size: cover; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".card {\n  max-width: 300px;\n  background-color: rgba(0, 0, 0, 0.125);\n  color: white; }\n\n.contentText {\n  font-size: 50px;\n  font-family: \"Lucida Sans\", \"Lucida Sans Regular\", \"Lucida Grande\", \"Lucida Sans Unicode\", Geneva, Verdana, sans-serif;\n  text-align: center; }\n\n.example-header-image {\n  background-image: url('windSpeed.png');\n  background-size: cover; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.getLastDataLog = function (data) {
        var headers = new _angular_http__WEBPACK_IMPORTED_MODULE_2__["Headers"]();
        headers.append('Content-Type', 'application/json');
...
var DataService = /** @class */ (function () {
    function DataService() {
        ...
        this.changePage = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"](true);
        this.currentPage = this.changePage.asObservable();
    }
    ...
    DataService.prototype.change = function (status) {
